<div class="container">
	 ...
	 <div class="row">
	 	<div class="col-sm-4" id="row-img">
	 		<img src="<?php echo base_url('assets/images/kids-shir-fo.jpg'); ?>" width="280" 
	 		data-toggle="modal" data-target="#shirtsModal">
	 	</div>
	 	<div class="col-sm-4" id="row-img">
	 		<img src="<?php echo base_url('assets/images/kids-pants.jpg'); ?>" width="200" data-toggle="modal" data-target="#pantsModal">
	 	</div>
	 	<div class="col-sm-4" id="row-img">
	 		<img src="<?php echo base_url('assets/images/kids-blazes.jpg'); ?>" width="180" data-toggle="modal" data-target="#blagerModal">
	 	</div>
	 </div>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <img src="<?php echo base_url('assets/images/kids-shir-fo.jpg'); ?>" width="100">
          <img src="<?php echo base_url('assets/images/kids-shirt.jpg'); ?>" width="100">
          <form role="form">
  ...
  <div class="modal fade" id="pantsModal" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <img src="<?php echo base_url('assets/images/kids-pants.jpg'); ?>" width="100">
          <img src="<?php echo base_url('assets/images/kids-pant.jpg'); ?>" width="100">
          <form role="form">
  ...
  <div class="modal fade" id="blagerModal" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <img src="<?php echo base_url('assets/images/kids-blazes.jpg'); ?>" width="100">
          <img src="<?php echo base_url('assets/images/kids-blazer.jpg'); ?>" width="100">
          <form role="form">
